...
public class Modificador {
    ...
    public static void cargarModificadores() {
        ...
        //Espinas #31
        modificadores.add(new Modificador(TipoModificador.DEBUFF, "Espinas", "<html><div style='width: 200px; text-align: justify;'>Cada vez que cambias de arma o agarras una nueva, te haces 1 de daño.</div></html>", "src/resources/sprites/modificadores/Espinas.png", 31));
        //ICD #32
